...
@bp.route("/replenishment", methods=["GET", "POST"])
@auth.login_required
@verify_balance
def replenishment():
    ...
    if not form.validate():
        ...
        return redirect(url_for("balances.i.replenishment", balance_id=g.balance.id))
    ...
    if category_id is not None:
        ...
        if category is None:
            ...
            return redirect(
                url_for("balances.i.replenishment", balance_id=g.balance.id)
            )
